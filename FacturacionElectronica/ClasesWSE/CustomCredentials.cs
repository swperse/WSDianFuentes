...
namespace FacturacionElectronica.ClasesWSE
{
    /// <summary>
    ///  Esta clasessirven para generar el SOAP Header de manera correcta como lo exige el servicio de 
    ///  Facturacion ELectronica de la DIAN pues necesita el Nonce y la fecha de solicitud del documento
    /// </summary>
